    ...
    <div dir="rtl" className="min-h-screen" style={{ background: "#FFFBEF" }}>
      ...
      <div className="fixed bottom-5 left-4 z-40 flex flex-col gap-3">
        ...
        <a
          ...
          className="flex items-center justify-center w-13 h-13 rounded-full shadow-lg transition-transform hover:scale-110 active:scale-95"
        ...
        >
          <svg viewBox="0 0 24 24" fill="white" width="26" height="26">
            ...
            <path d="M12 0C5.373 0 0 5.373 0 12c0 2.124.554 4.118 1.522 5.845L.057 23.522a.5.5 0 0 0 .609.61l5.733-1.499A11.943 11.943 0 0 0 12 24c6.627 0 12-5.373 12-12S18.627 0 12 0zm0 22c-1.907 0-3.693-.5-5.24-1.374l-.374-.214-3.875 1.013 1.013-3.754-.228-.384A9.962 9.962 0 0 1 2 12C2 6.477 6.477 2 12 2s10 4.477 10 10-4.477 10-10 10z" />
          </svg>
        </a>
        {/* Accessibility */}
        <button
          ...
          style={{ width: 52, height: 52, background: "#1C1A10", border: "2px solid #F0C040" }}
        >
          <svg viewBox="0 0 24 24" fill="#F0C040" width="26" height="26">
            <circle cx="12" cy="4" r="2" />
            <path d="M19 9H5a1 1 0 0 0 0 2h4.5l-1.75 8.5a1 1 0 0 0 1.96.4L11 13h2l1.29 6.9a1 1 0 0 0 1.96-.4L14.5 11H19a1 1 0 0 0 0-2z" />
          </svg>
        </button>
      </div>
